...
k_list = [5,10,20,39,56,75,95,120,185,372,550,724,918,1372,1843]
#k_list = [5,10,20]
...
#k_number = 120
	...
	N_features = int(0.4*k_number)
	
	start_train_time = time.time()
	forest = random_forest_algorithm(train_df, n_trees=400, n_bootstrap=100, n_features=N_features, dt_max_depth=10)
	...
	title_name = str('confusion_matrix_'+'acc='+str(accuracy)+'_k'+str(k_number)+'_trees400_bootstrap100_features0.4_depth_10.png')
	plt.savefig(title_name)
	#plt.show()
	plt.close()

		
#title_name = str('accuracy_axis-aligned_traintesttime_trees10_bootstrap100_features0.8_depth10.png')
...
lns1 = ax.plot(k_list, train_time_list, '-r', label = 'train_time')
lns2 = ax.plot(k_list, test_time_list, '-g', label = 'test_time')
ax2 = ax.twinx()
lns3 = ax2.plot(k_list, accuracy_list, '-b', label = 'accuracy')
