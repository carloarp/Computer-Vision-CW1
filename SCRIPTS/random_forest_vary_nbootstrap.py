...
N_bootstrap_list 	= [50,60,70,80,90,100,120,140,150]

for item in N_bootstrap_list:
	
	start_train_time = time.time()
	forest = random_forest_algorithm(train_df, n_trees=10, n_bootstrap=item, n_features=100, dt_max_depth=10)
...
lns1 = ax.plot(N_bootstrap_list, train_time_list, '-r', label = 'train_time')
lns2 = ax.plot(N_bootstrap_list, test_time_list, '-g', label = 'test_time')
ax2 = ax.twinx()
lns3 = ax2.plot(N_bootstrap_list, accuracy_list, '-b', label = 'accuracy')
