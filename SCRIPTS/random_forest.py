...
#print(test_df.iloc[:,0:k_number].values)
#print(test_df.iloc[:,0:k_number].values.shape)				
...
forest = random_forest_algorithm(train_df, n_trees=100, n_bootstrap=100, n_features=20, dt_max_depth=1000)
...
title_name = str('confusion_matrix_'+'acc='+str(accuracy)+'_k'+str(k_number)+'_trees400_bootstrap100_features20_depth_10.png')
